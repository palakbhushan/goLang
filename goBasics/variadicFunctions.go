// function parameter with eliipsis(...)
package main
import "fmt"
...
func main() {
	...
	//mandatory to pass variadic parameter as last paramenter of function
	...
	sequence3, total3 := sum(3, numbers...)  //destructure the array or slice
